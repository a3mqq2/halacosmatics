        ...
        <div class="card border-0 shadow-sm rounded-4">
            <div class="card-body p-4">
                <h5 class="fw-bold mb-4" style="color:#4a2619">
                    <i class="ti ti-map-pin me-1"></i> تعديل المنطقة
                </h5>

                <form method="POST" action="{{ route('delivery_areas.update', $area) }}">
                    @csrf @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <input type="number" name="price" min="0" max="9999"
                                   ...
                                   value="{{ old('price', $area->price) }}" required>
