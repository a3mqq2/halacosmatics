...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0 fw-bold"><i class="ti ti-user-plus me-1"></i> إضافة مستخدم جديد</h5>
    </div>
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('users.store') }}">
                        ...
                        <div class="d-flex align-items-center gap-2 mb-3 pb-3 border-bottom">
                            <div class="form-check form-switch mb-0">
                                <input class="form-check-input" type="checkbox" name="is_super" id="isSuper" value="1"
                                       {{ old('is_super') ? 'checked' : '' }} onchange="togglePerms(this)">
                        ...
                        <div id="granularPerms">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex flex-wrap gap-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input perm-toggle" type="checkbox" name="perm_users" id="permUsers" value="1" {{ old('perm_users') ? 'checked' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="row g-2">
                                    <div class="col-12 col-sm-6 col-md-4">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input perm-toggle orders-perm" type="checkbox" name="perm_orders_pending" id="permOrdersPending" value="1" {{ old('perm_orders_pending') ? 'checked' : '' }}>
                                            <label class="form-check-label" for="permOrdersPending">عرض الطلبات الجديدة</label>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6 col-md-4">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input perm-toggle orders-perm" type="checkbox" name="perm_orders_active" id="permOrdersActive" value="1" {{ old('perm_orders_active') ? 'checked' : '' }}>
                                            <label class="form-check-label" for="permOrdersActive">عرض قيد التجهيز والمندوب</label>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6 col-md-4">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input perm-toggle orders-perm" type="checkbox" name="perm_orders_delivered" id="permOrdersDelivered" value="1" {{ old('perm_orders_delivered') ? 'checked' : '' }}>
                                            <label class="form-check-label" for="permOrdersDelivered">عرض الطلبات المستلمة</label>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6 col-md-4">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input perm-toggle orders-perm" type="checkbox" name="perm_orders_returned" id="permOrdersReturned" value="1" {{ old('perm_orders_returned') ? 'checked' : '' }}>
                                            <label class="form-check-label" for="permOrdersReturned">عرض الطلبات المستردة</label>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6 col-md-4">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input perm-toggle orders-perm" type="checkbox" name="perm_orders_approve" id="permOrdersApprove" value="1" {{ old('perm_orders_approve') ? 'checked' : '' }}>
                                            <label class="form-check-label" for="permOrdersApprove">قبول / رفض الطلبات</label>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6 col-md-4">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input perm-toggle orders-perm" type="checkbox" name="perm_orders_deliver" id="permOrdersDeliver" value="1" {{ old('perm_orders_deliver') ? 'checked' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="row g-2">
                                    <div class="col-12 col-sm-6 col-md-4">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input perm-toggle" type="checkbox" name="perm_agents" id="permAgents" value="1" {{ old('perm_agents') ? 'checked' : '' }}>
                                            <label class="form-check-label" for="permAgents">إدارة المندوبين</label>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6 col-md-4">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input perm-toggle" type="checkbox" name="perm_vaults" id="permVaults" value="1" {{ old('perm_vaults') ? 'checked' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="row g-2">
                                    <div class="col-12 col-sm-6 col-md-4">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input perm-toggle products-perm" type="checkbox" name="perm_products_view" id="permProductsView" value="1" {{ old('perm_products_view') ? 'checked' : '' }}>
                                            <label class="form-check-label" for="permProductsView">عرض المنتجات</label>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6 col-md-4">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input perm-toggle products-perm" type="checkbox" name="perm_products_prices" id="permProductsPrices" value="1" {{ old('perm_products_prices') ? 'checked' : '' }}>
                                            <label class="form-check-label" for="permProductsPrices">رؤية الأسعار</label>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6 col-md-4">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input perm-toggle products-perm" type="checkbox" name="perm_products_costs" id="permProductsCosts" value="1" {{ old('perm_products_costs') ? 'checked' : '' }}>
                                            <label class="form-check-label" for="permProductsCosts">رؤية التكاليف</label>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6 col-md-4">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input perm-toggle products-perm" type="checkbox" name="perm_products_edit" id="permProductsEdit" value="1" {{ old('perm_products_edit') ? 'checked' : '' }}>
                                            <label class="form-check-label" for="permProductsEdit">إضافة وتعديل المنتجات</label>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6 col-md-4">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input perm-toggle products-perm" type="checkbox" name="perm_products_stock" id="permProductsStock" value="1" {{ old('perm_products_stock') ? 'checked' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="row g-2">
                                    <div class="col-12 col-sm-6 col-md-4">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input perm-toggle marketers-perm" type="checkbox" name="perm_marketers_view" id="permMarketersView" value="1" {{ old('perm_marketers_view') ? 'checked' : '' }}>
                                            <label class="form-check-label" for="permMarketersView">عرض المسوقين</label>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6 col-md-4">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input perm-toggle marketers-perm" type="checkbox" name="perm_marketers_manage" id="permMarketersManage" value="1" {{ old('perm_marketers_manage') ? 'checked' : '' }}>
                                            <label class="form-check-label" for="permMarketersManage">قبول ورفض وتعديل</label>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6 col-md-4">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input perm-toggle marketers-perm" type="checkbox" name="perm_marketers_finance" id="permMarketersFinance" value="1" {{ old('perm_marketers_finance') ? 'checked' : '' }}>
                            ...
                            <div class="mb-0">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input perm-toggle" type="checkbox" name="perm_reports" id="permReports" value="1" {{ old('perm_reports') ? 'checked' : '' }}>
            ...
            <div class="d-flex gap-2 mt-4">
                <button type="submit" class="btn btn-primary">
                    <i class="ti ti-device-floppy me-1"></i> حفظ المستخدم
                </button>
